namespace EliteDangerous.Test
{
    ...
    {
        const string CSV_FILE_PATH = @"C:\Adi\systems.csv";
        ...
        public static System.Collections.Generic.IEnumerable<StarSystem> GetAllSystemsHighMemory()
        {
            var lines = System.IO.File.ReadAllLines(CSV_FILE_PATH, System.Text.Encoding.ASCII);
